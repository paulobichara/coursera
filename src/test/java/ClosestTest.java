...
public class ClosestTest {
    ...
    private static final int STRESS_ARRAY_MAX_SIZE = 15;
    ...
    public void testSamples() {
        ...
        assertMinDistance(createPointArray(new long[]{ 4, 0, 9, 4, 6 }, new long[]{ 0, -2, 6, 2, 4 }), 2.0);
        assertMinDistance(createPointArray(new long[]{ 8, -5, 9, 6, -8, 8, -6, 5, 4, -9 }, new long[]{ 0, 6, -2, 6, -7, -7, 5, 6, -4, -4 }), 1.0);
        assertMinDistance(createPointArray(new long[]{ -7, -10, -6, 8, 7, -9, 7, 5, -2, 4, -1, -9, 6, 2, 1 }, new long[]{ -8, -10, -7, -4, -2, -9, 9, -2, 1, -5, -6, -10, 6, 4, -5 }), 1.0);
    }
